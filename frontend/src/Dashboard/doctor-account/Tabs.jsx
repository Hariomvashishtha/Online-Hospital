...
const Tabs = ({ tab, settab }) => {
  ...
  return (
    <div>
      ...
      <div className="hidden lg:flex flex-col p-[30px] bg-[rgb(249,242,242)]  shadow-panelShadow items-center h-max rounded-md ml-[30px] ">
        ...
        <div className="mt-[100px] md:mt-[20px] w-full">
